...
st.title("Eat and Fit - Nutrition Insights")
st.subheader("Cleaned Nutrition Dataset")
st.dataframe(data)
st.markdown(
    f"""
        <style>
    ...
    match body:
     ...
     body == 0:
        ...
        with engine.connect() as conn:
            ...
            sc_result = conn.execute(text("SELECT * FROM StandardCalories WHERE Stage = :stage AND Body = :body AND Sex = :sex"), 
